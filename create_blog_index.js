...
const newHead = baseHead + '\n' + blogStyles;

// Extract header and footer
const headerMatch = indexContent.match(/<header class="landing-header">[\s\S]*?<\/header>/);
const header = headerMatch ? headerMatch[0].replace('href="#how-it-works"', 'href="/#how-it-works"').replace('href="#features"', 'href="/#features"').replace('href="#faq"', 'href="/#faq"') : '';
...
const blogHtml = \`${newHead}
  ...
  <script>
    // ARRAY DE ARTICULOS (Añade nuevos artículos aquí arriba)
    const articles = [
      {
      ...
      currentArticles.forEach(article => {
        ...
        card.innerHTML = \`
          ...
          <div class="blog-content">
            ...
            <a href="\${article.url}" class="read-more">Leer más &rarr;</a>
          </div>
        \`;
