...
const headEndIndex = indexContent.indexOf('</style>');
const baseHead = indexContent.substring(0, headEndIndex);

const headerStartIndex = indexContent.indexOf('<header class="landing-header">');
const headerEndIndex = indexContent.indexOf('</header>') + '</header>'.length;
let header = indexContent.substring(headerStartIndex, headerEndIndex);

header = header.replace('href="#how-it-works"', 'href="/#how-it-works"')
               .replace('href="#features"', 'href="/#features"')
               .replace('href="#faq"', 'href="/#faq"');

const footerStartIndex = indexContent.indexOf('<footer class="landing-footer">');
const footerEndIndex = indexContent.indexOf('</footer>') + '</footer>'.length;
const footer = indexContent.substring(footerStartIndex, footerEndIndex);
...
const blogHtml = baseHead + blogStyles + '</style>\\n</head>\\n<body>\\n' + header + '\\n' + htmlContent + '\\n' + footer + '\\n' + scriptContent + '\\n</body>\\n</html>';
